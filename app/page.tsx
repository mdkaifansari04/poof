...
import { LandingSeoDetails, landingFaqForJsonLd } from '@/components/landing/seo-details'

const appUrl = process.env.NEXT_PUBLIC_APP_URL || 'https://poof.k04.tech'
const pageTitle = 'Poof | Expiring Photo Sharing Links for Galleries and Images'
...
export default function LandingPage() {
  ...
  const faqJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'FAQPage',
    mainEntity: landingFaqForJsonLd.map((faq) => ({
      '@type': 'Question',
      name: faq.question,
      acceptedAnswer: {
        '@type': 'Answer',
