    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20 pt-32">
        ...
        <p className="text-lg sm:text-xl text-poof-mist max-w-2xl mx-auto mb-10 animate-fade-up stagger-2 text-balance">
          Create galleries, share a single photo or a selected set, and control
          expiry exactly how you want. When a link expires or is revoked, access
          ends instantly.
        </p>
